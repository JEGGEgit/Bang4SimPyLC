...
class Cell:
    ...
    def __init__ (self, moduleWindow, module, element):
        ...
        if isinstance (self.element, en._PageCaption):
            ...
            self.label.bind ('<ButtonPress-1>', lambda event: self.moduleWindow.goPage (self.moduleWindow.pageIndex - 1))
            self.label.bind ('<ButtonPress-2>', lambda event: self.moduleWindow.goPage (self.moduleWindow.pageIndex + 1))
    ...
    def force (self, event):
        ...
        if self.element._forced:
            ...
            except:     # prevent <string> SyntaxError: invalid syntax @mje
                pass
...
class ModuleWindow (Toplevel):
    ...
    def readFromEngine (self):
        for cell in self.cells:
            ...
            except:     # prevent _tkinter.TclError: invalid command name ".!modulewindow2.!entry129"
                pass
                # prevent crash while closing just one window @mje
