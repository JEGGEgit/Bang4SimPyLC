...
class ColorsHex:
    def __init__ (self):
        ...
        self.labelForegroundColor = '#aaaaaa'           # all except timing @mje
        self.labelBackgroundColor = self.panelBackgroundColor

        self.entryReleasedForegroundColor = '#00ff00'
        self.entryReleasedBackgroundColor = '#000000'   # '#002200' @mje
        self.entryEditForegroundColor = '#bbbbff'
        self.entryEditBackgroundColor = '#000022'
        self.entryForcedForegroundColor = '#000000'     # '#ffaa00' @mje
        self.entryForcedBackgroundColor = '#ffaa00'     # '#331100' forced @mje
        ...
        self.black = '#000000'
        self.red = '#ff0000'
        self.orange = '#ffaa00'                         # '#ffaa00' forced @mje 
        self.maroon = '#800000'
        self.yellow = '#ffff00'
        self.olive = '#808000'
        self.lime = '#00ff00'
